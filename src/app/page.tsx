...
function AuthPage() {
  ...
  useEffect(() => {
    ...
    if (urlError) {
      const errorMessages: Record<string, string> = {
        ...
        oauth_error: "Microsoft sign-in was cancelled or failed. Please try again.",
      };
      setAuthError(errorMessages[urlError] || "An error occurred during authentication.");
    }
    if (urlSuccess === "true") {
  ...
  const handleMicrosoftSignIn = async () => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Microsoft sign-in failed. Please check your configuration.";
        ...
        <header className="border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-slate-900 dark:text-white text-lg">SecurePortal</span>
              <Badge variant="secondary" className="hidden sm:inline-flex text-xs">Production</Badge>
            </div>
                ...
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    ...
                    {session.user.emailVerified && (
                      <Badge variant="secondary" className="w-fit text-xs mt-1 bg-emerald-50 text-emerald-700 border-emerald-200">
                        Verified
                      </Badge>
                    )}
                  </div>
            ...
            <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
              <CardHeader>
                ...
                <CardDescription className="text-slate-500 dark:text-slate-400">
                  You&apos;re securely signed in. Your session is active and protected.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid sm:grid-cols-3 gap-4">
                  <div className="rounded-xl border border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <p className="text-lg font-semibold text-emerald-600 dark:text-emerald-400">Authenticated</p>
                  </div>
                  <div className="rounded-xl border border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-800/50">
                    <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="rounded-xl border border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <p className="text-sm font-medium text-slate-900 dark:text-white">Active (7 days)</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">End your current session securely</p>
                    </div>
                  </Button>
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      ...
                      >
                        ...
                        <div className="text-left">
                          <p className="font-medium text-slate-900 dark:text-white">Security Settings</p>
                          <p className="text-xs text-slate-500 dark:text-slate-400">Manage password and security</p>
                        </div>
                      </Button>
                    </DialogTrigger>
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>Manage your account security preferences.</DialogDescription>
                      </DialogHeader>
                        ...
                        <div className="flex items-center justify-between p-3 rounded-lg border border-slate-200 dark:border-slate-700">
                          <div>
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400">
                              {session.user.emailVerified ? "Your email is verified" : "Verify your email address"}
                            </p>
                          </div>
                          {session.user.emailVerified ? (
                            <Badge variant="secondary" className="bg-emerald-50 text-emerald-700 border-emerald-200">Verified</Badge>
                          ) : (
        ...
        <footer className="border-t border-slate-200 dark:border-slate-800 mt-auto">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500 dark:text-slate-400">
              ...
              <p>&copy; {new Date().getFullYear()} All rights reserved. Secured with Microsoft Entra ID.</p>
            </div>
          </div>
        </footer>
      </div>
          ...
          <CardContent className="pt-4">
            ...
            >
              {loading ? (
                ...
                <>
                  <svg className="h-5 w-5 mr-2.5" viewBox="0 0 21 21" fill="none">
                  ...
                  {!isSignUp && (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setAuthError("Password reset: Set up an email service (see setup instructions) to enable password reset.");
                      }}
                    >
                      Forgot password?
                    </button>
